# -*- coding: utf-8 -*-
"""SMEs_financial_data_100.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/16hVCbpok5FD6sIFbLHoilk50mrJlwFgR
"""
...
# ─── Figure 1: Class Distribution & Missing Values Overview ─────────────────
fig, axes = plt.subplots(1, 3, figsize=(16, 5))
fig.suptitle("Figure 1 — Data Overview", fontsize=14, fontweight='bold', y=1.01)
...
plt.tight_layout()
plt.savefig("/content/fig1_data_overview.png", dpi=150, bbox_inches='tight')
plt.close()
print("  [OK] fig1_data_overview.png")

from IPython.display import Image
Image('/content/fig1_data_overview.png')

# ─── Figure 2: CV Performance Comparison (MC3) ──────────────────────────────
fig, axes = plt.subplots(2, 4, figsize=(18, 9))
fig.suptitle("Figure 2 — 5-Fold Cross-Validation: Per-Metric Distribution\n"
...
plt.tight_layout()
plt.savefig("/content/fig2_cv_comparison.png", dpi=150, bbox_inches='tight')
plt.close()
print("  [OK] fig2_cv_comparison.png")

from IPython.display import Image
Image('/content/fig2_cv_comparison.png')

# ─── Figure 3: ROC Curves — All Models (MC7) ────────────────────────────────
fig, axes = plt.subplots(1, 2, figsize=(14, 6))
fig.suptitle("Figure 3 — ROC Curves & Precision-Recall Curves (Held-Out Test Set)",
...
plt.tight_layout()
plt.savefig("/content/fig3_roc_pr_curves.png", dpi=150, bbox_inches='tight')
plt.close()
print("  [OK] fig3_roc_pr_curves.png")

from IPython.display import Image
Image('/content/fig3_roc_pr_curves.png')

# ─── Figure 4: Confusion Matrices — All 3 Models ────────────────────────────
fig, axes = plt.subplots(1, 3, figsize=(16, 5))
fig.suptitle("Figure 4 — Confusion Matrices (Held-Out Test Set, N=140)",
             fontsize=13, fontweight='bold')
...
plt.tight_layout()
plt.savefig("/content/fig4_confusion_matrices.png", dpi=150, bbox_inches='tight')
plt.close()
print("  [OK] fig4_confusion_matrices.png")

from IPython.display import Image
Image('/content/fig4_confusion_matrices.png')

# ─── Figure 5: CV Metrics Bar Chart with Error Bars (MC3) ───────────────────
fig, axes = plt.subplots(1, 2, figsize=(14, 6))
fig.suptitle("Figure 5 — Cross-Validation Mean ± SD  (5 Folds)",
             fontsize=13, fontweight='bold')
...
plt.tight_layout()
plt.savefig("/content/fig5_cv_bar_chart.png", dpi=150, bbox_inches='tight')
plt.close()
print("  [OK] fig5_cv_bar_chart.png")

from IPython.display import Image
Image('/content/fig5_cv_bar_chart.png')
...
plt.tight_layout()
plt.savefig("/content/fig6_variable_importance.png", dpi=150, bbox_inches='tight')
plt.close()
...
# ─── Figure 7: MLP Learning Curves (MC6 — Overfitting Controls) -------------
...
fig.suptitle("Figure 7 — MLP Learning Curves (MC6: Overfitting Controls)",
             fontsize=13, fontweight='bold')
...
plt.tight_layout()
plt.savefig("/content/fig7_learning_curves.png", dpi=150, bbox_inches='tight')
plt.close()
print(f"  [OK] fig7_learning_curves.png  (early stop @ epoch {n_iters})")

from IPython.display import Image
Image('/content/fig7_learning_curves.png')
...
plt.tight_layout()
plt.savefig("/content/fig8_radar_chart.png", dpi=150, bbox_inches='tight')
plt.close()
